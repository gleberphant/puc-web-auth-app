...
| :--------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Senhas armazenadas ou comparadas em texto puro       | Armazenar somente hashes seguros, como bcrypt ou Argon2, e comparar a senha usando uma função própria para validação de hash. Nunca salvar ou registrar a senha original.              |
